...
function fossdLoad() {
    try {
        ...
        document.getElementById("sav_file2").addEventListener("change", handleFileSelect, false);
        document.getElementById("json_file2").addEventListener("change", handleFileSelect, false)
    } catch (e) {
        alert("Error: " + e)
    }
}